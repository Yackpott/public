...
URL = 'https://sso.uc.cl/cas/login?service=http%3A%2F%2Fintranetfacea.uc.cl%2Flogin'
...
def recursos_get():
    ...
    responsePOST = session.post(URL, headers={'referer': 'http://intranetfacea.uc.cl/'}, data=params, cookies=cookies)
